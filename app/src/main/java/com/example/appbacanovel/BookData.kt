    ...
    fun getBookList(): List<Book> {
        ...
        return listOf(
            ...
            Book(6, "Kita & Waktu: Langit & Senja ",
                "Aireen Natasha",
                "uku ini menceritakan kisah tentang dua individu yang berjuang melawan waktu dan keadaan untuk menemukan cinta sejati mereka. Dalam perjalanan mereka, ada banyak tantangan, harapan, dan perasaan yang menyelimuti, namun pada akhirnya mereka sadar bahwa cinta bisa mengalahkan segala rintangan.",
                "Kisah dimulai dengan pertemuan tak terduga antara dua jiwa yang terjebak dalam dunia yang berbeda. Mereka saling mencintai namun harus menghadapi kenyataan yang memisahkan mereka. Di tengah kesulitan dan perbedaan, mereka belajar bahwa cinta membutuhkan pengorbanan dan keteguhan hati untuk tetap bersama.", R.drawable.cover6,
                "Gramedia",
                "2021",
                dateFormat.parse("2021-10-10") ?: Date(),
                genre.ROMANCE),
            ...
            Book(8, "The First Game ",
                ...
                "Kisah ini menceritakan hubungan antara Hana dan Kento, yang memulai sebuah permainan berisiko tinggi, menguji perasaan mereka, dan berhadapan dengan realitas dunia sekolah. Mereka harus memilih apakah akan terus bermain atau mengakhiri permainan tersebut, sambil belajar tentang cinta dan kebersamaan.", R.drawable.cover8,
                "Phoenix Publishing",
                "2020",
                dateFormat.parse("2020-07-25") ?: Date(),
                genre.SCIENCE),
            ...
            Book(9, "The Romance Rivalry ",
                ...
                "awokawk", R.drawable.cover9,
                "HarperCollins",
                "2022",
                dateFormat.parse("2022-02-14") ?: Date(),
                genre.ROMANCE),
            ...
            Book(10, "Matilda",
                ...
                "uku ini menceritakan perjalanan Matilda yang berusaha untuk mengatasi masalah-masalah yang ada di rumah dan sekolahnya. Dengan kemampuan luar biasa yang dimilikinya, Matilda akhirnya berhasil menghadapi ketidakadilan dan menunjukkan kepada dunia bahwa meskipun kecil, dia bisa membuat perbedaan besar.", R.drawable.cover10,
                "Penguin Books",
                "1988",
                dateFormat.parse("1988-10-01") ?: Date(),
                genre.FICTION),
