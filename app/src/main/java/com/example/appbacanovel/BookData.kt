...
object BookData {
    fun getBookList(): List<Book> {
        ...
        return listOf(
            ...
            Book(6, "Kita & Waktu: Langit & Senja",
                "Aireen Natasha",
                "Buku ini menceritakan kisah tentang dua individu yang berjuang melawan waktu dan keadaan untuk menemukan cinta sejati mereka. Dalam perjalanan mereka, ada banyak tantangan, harapan, dan perasaan yang menyelimuti, namun pada akhirnya mereka sadar bahwa cinta bisa mengalahkan segala rintangan.",
                "Kisah dimulai dengan pertemuan tak terduga antara dua jiwa yang terjebak dalam dunia yang berbeda. Mereka saling mencintai namun harus menghadapi kenyataan yang memisahkan mereka. Di tengah kesulitan dan perbedaan, mereka belajar bahwa cinta membutuhkan pengorbanan dan keteguhan hati untuk tetap bersama.",
                R.drawable.cover6,
                "Gramedia",
                "2021",
                System.currentTimeMillis(),
            ...
            Book(7, "Forel Sket",
                "Mimi Daisy",
                "Buku ini mengikuti kisah dua remaja yang menghadapi kebingungan dan kegelisahan dalam menjalin hubungan. Ketika keadaan tak sesuai dengan harapan mereka, keduanya mencoba untuk memahami satu sama lain dan menghadapi konflik dengan cara yang unik dan lucu.",
                "Dalam kisah ini, si gadis bernama Aira yang merasa cemas tentang perasaannya terhadap teman lamanya, Reza. Aira berusaha mengatasi rasa canggung dan perasaan terpendam, sementara Reza berusaha memahami segala keraguan yang muncul. Meskipun penuh kebingungan, mereka berusaha mencari jalan untuk memulai kisah mereka dengan cara mereka sendiri.",
                R.drawable.cover7,
                "Elex Media",
                "2022",
                System.currentTimeMillis(),
            ...
            Book(8, "The First Game",
                "im evve",
                "Sebuah kisah romansa remaja yang berawal dari sebuah permainan pertama yang mereka jalani bersama. Dalam dunia yang penuh tantangan dan ujian, kedua karakter utama ini belajar tentang perasaan mereka satu sama lain, meskipun sering kali merasa bingung dan tidak yakin.",
                "Kisah ini menceritakan hubungan antara Hana dan Kento, yang memulai sebuah permainan berisiko tinggi, menguji perasaan mereka, dan berhadapan dengan realitas dunia sekolah. Mereka harus memilih apakah akan terus bermain atau mengakhiri permainan tersebut, sambil belajar tentang cinta dan kebersamaan.",
                R.drawable.cover8,
                "Phoenix Publishing",
                "2020",
                System.currentTimeMillis(),
            ...
            Book(9, "The Romance Rivalry",
                "Susan Lee",
                "Dalam kisah ini, dua individu yang bersaing dalam dunia romansa menghadapi berbagai rintangan yang menguji perasaan mereka. Mereka mulai sadar bahwa persaingan mereka bukanlah soal siapa yang menang, melainkan soal memahami hati dan perasaan masing-masing.",
                "Buku ini berfokus pada kisah rivalitas antara Mia dan Daniel yang mulai terbawa dalam hubungan yang lebih dalam dari sekadar persaingan. Seiring berjalannya waktu, mereka mulai menghadapi kenyataan bahwa ada banyak hal yang bisa mereka pelajari satu sama lain. Persaingan berubah menjadi persahabatan yang penuh dengan kejutan dan romansa.",
                R.drawable.cover9,
                "HarperCollins",
                "2022",
                System.currentTimeMillis(),
            ...
            Book(10, "Matilda",
                "Roald Dahl",
                "Matilda adalah seorang gadis kecil yang memiliki kecerdasan luar biasa dan kemampuan telekinetik. Meskipun demikian, dia harus menghadapi orangtua yang tidak peduli dan guru yang galak. Dengan keberanian dan kecerdasannya, Matilda berusaha untuk memperbaiki keadaan di sekitarnya.",
                "Buku ini menceritakan perjalanan Matilda yang berusaha untuk mengatasi masalah-masalah yang ada di rumah dan sekolahnya. Dengan kemampuan luar biasa yang dimilikinya, Matilda akhirnya berhasil menghadapi ketidakadilan dan menunjukkan kepada dunia bahwa meskipun kecil, dia bisa membuat perbedaan besar.",
                R.drawable.cover10,
                "Penguin Books",
                "1988",
                System.currentTimeMillis(),
            ...
            Book(11, "Soul",
                "Pixar, Disney",
                "Joe Gardner adalah seorang guru musik yang memiliki impian untuk menjadi musisi jazz profesional. Ketika ia akhirnya mendapat kesempatan tampil di panggung besar, ia mengalami kecelakaan yang membuatnya terjebak di dunia roh. Di sana, Joe bertemu dengan 22, seorang roh yang tidak tertarik pada kehidupan di bumi. Bersama-sama, mereka menjelajahi makna hidup, passion, dan tujuan.",
                "Joe berusaha menemukan jalan kembali ke tubuhnya, sementara 22 yang sudah lama menolak kehidupan di bumi mulai belajar tentang arti dari semangat hidup. Dalam petualangan mereka, Joe dan 22 menemukan bahwa hidup bukan hanya tentang pencapaian, tetapi tentang menikmati setiap momen dan membagikan kebahagiaan dengan orang lain.",
                R.drawable.cover11,
                "Disney Pixar",
                "2020",
                System.currentTimeMillis(),
            ...
            Book(12, "Brave",
                ...
                "Merida, seorang putri Skotlandia yang pemberani, berusaha untuk membuktikan bahwa ia bisa mengendalikan takdirnya sendiri. Setelah sebuah tindakan ceroboh yang mengubah hidup ibunya, Merida memulai petualangan untuk memperbaiki kesalahan tersebut dan belajar mengenai cinta, tanggung jawab, dan keberanian sejati.",
                "Merida yang ingin hidup bebas tanpa batasan sosial, mencoba merubah takdir yang sudah digariskan untuknya. Ia terjebak dalam konflik dengan ibunya dan harus mencari cara untuk memperbaiki kekacauan yang telah ia ciptakan. Petualangannya membawanya pada pemahaman yang lebih dalam tentang nilai keluarga dan keberanian untuk menghadapi masa depan.",
                R.drawable.cover12,
            ...
            Book(13, "Raya and the Last Dragon",
                "Disney Animation Studios",
                "Raya adalah seorang pejuang muda yang berusaha untuk menemukan naga terakhir dan menyelamatkan kerajaannya yang dilanda kegelapan. Dalam perjalanannya, ia belajar tentang kepercayaan, persatuan, dan kekuatan untuk menyelamatkan dunia yang terancam hancur.",
                "Raya melakukan perjalanan melintasi dunia yang fantastis dan penuh tantangan untuk menemukan Sisu, seekor naga yang mampu menyelamatkan dunia dari ancaman kekuatan jahat. Dalam petualangannya, ia menghadapi berbagai rintangan yang menguji tekad dan keyakinannya terhadap dunia dan teman-temannya.",
                R.drawable.cover13,
                "Walt Disney Studios",
                "2021",
                System.currentTimeMillis(),
            ...
            Book(14, "The Lost Wonderland Diaries",
                "J. Scott Savage",
                "Dua anak muda menemukan buku yang membawa mereka ke dunia penuh keajaiban yang hilang. Di sana, mereka bertemu dengan berbagai karakter aneh dan mencari cara untuk mengungkap misteri yang tersembunyi di Wonderland yang terlupakan. Dengan bantuan teman-teman baru mereka, mereka berusaha untuk mengembalikan keajaiban yang telah lama hilang.",
                "Petualangan ini mengikuti perjalanan dua anak yang terperangkap dalam dunia penuh petunjuk dan teka-teki. Mereka belajar untuk bekerja sama dan menggali masa lalu yang terpendam untuk mengungkapkan rahasia yang bisa menyelamatkan dunia Wonderland yang terlupakan dari kehancuran.",
                R.drawable.cover14,
                "Shadow Mountain",
                "2020",
                System.currentTimeMillis(),
            ...
            Book(15, "The Keeper",
                ...
                "Sebuah kisah misteri yang menggugah, di mana dua remaja terjebak dalam sebuah rumah yang tampaknya kosong, namun menyimpan rahasia gelap. Mereka harus berhadapan dengan kekuatan gaib yang mengintai mereka dari setiap sudut rumah tersebut. Dengan keberanian dan rasa ingin tahu, mereka mencoba memecahkan misteri yang mengancam keselamatan mereka.",
                "Tiga remaja muda yang ingin menyelidiki sebuah rumah tua yang memiliki sejarah kelam. Mereka berusaha mengungkap kebenaran tentang siapa yang mengawasi rumah tersebut dan apa yang terjadi pada orang-orang yang tinggal di sana sebelumnya. Setiap langkah yang mereka ambil semakin mendekatkan mereka pada ancaman yang lebih besar.",
                R.drawable.cover15,
                "Scholastic Press",
                "2021",
                System.currentTimeMillis(),
            ...
            Book(16, "Cantik Itu Luka",
                "Eka Kurniawan",
                "Buku ini mengisahkan tentang seorang wanita bernama Dewi Ayu, yang hidup dalam dunia yang penuh dengan kekerasan, cinta, dan penderitaan. Dengan gaya yang menggugah dan penuh satire, Eka Kurniawan membawa pembaca untuk menyelami kisah Dewi Ayu yang berjuang untuk menemukan makna hidup di tengah kebrutalan dunia.",
                "Dewi Ayu, seorang wanita yang tampaknya memiliki kehidupan yang sempurna, terjebak dalam kisah cinta yang rumit dan penuh pengkhianatan. Buku ini mengungkapkan realitas kehidupan yang gelap dan kejam melalui narasi yang tajam dan kritis terhadap kebijakan sosial dan politik. Dengan menggabungkan elemen-elemen fiksi, satir, dan sejarah, \"Cantik Itu Luka\" mengeksplorasi penderitaan dan harapan manusia dalam menghadapi ketidakadilan.",
                R.drawable.cover16,
